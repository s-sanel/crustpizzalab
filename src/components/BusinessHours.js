...
const BusinessHours = () => {
    return (
      <div className='business-hours-container fluid-container py-5'>
        <div className="business-hours row mx-0 justify-content-md-center" style={{}}>
            <div className="business-hours-content col-sm-12 col-lg-8">
                <h2>ÖPPETTIDER</h2>
